...
//---- PROXY FUNCTIONS ------------------------------------------------------------------------
		...
		public static function tintProxy($o:Object, $time:Number):void {
		...
		public static function frameProxy($o:Object, $time:Number):void {
			$o.info.target.gotoAndStop(Math.round($o.target.frame));
		}
		public static function volumeProxy($o:Object, $time:Number):void {
